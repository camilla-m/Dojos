...
public class BallFactory {
    ...
    public static Ball[] all() {
        return new Ball[]{
                ...
                genralBall(350, 100, Ball.DEFAULT_RADIUS, ElasticBall.SHRINK,BouncingBall.DOWN, SlidingBehaviour.LEFT)
    ...
    public  static  Ball genralBall(int centerX, int centerY, int radius, int growthDirection ,int direction,int slidDirection){
        return new GeneralBall(centerX,centerY,radius,growthDirection,direction,slidDirection);
    }
}
